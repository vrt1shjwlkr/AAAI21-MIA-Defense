...
def train(train_data,labels,model,criterion,optimizer,epoch,use_cuda,num_batchs=999999,debug_='MEDIUM',batch_size=32, uniform_reg=False):
...
def test(test_data,labels,model,criterion,use_cuda,debug_='MEDIUM',batch_size=16):
